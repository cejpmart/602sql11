...
#ifndef _XMLELEMENT10DLG_H_
#define _XMLELEMENT10DLG_H_

#if defined(__GNUG__) && !defined(__APPLE__)
//#pragma interface "XMLElement10Dlg.cpp"
#endif
...
#define SYMBOL_XMLELEMENTDLG_IDNAME ID_MYDIALOG6
...
#define CD_XML_DATASOURCE_C 10107
#define CD_XML_DATASOURCE 10104
#define CD_XML_SCHEMA_C 10109
#define CD_XML_SCHEMA 10105
...
public:
    ...
    /// Creation
    bool Create( wxWindow* parent, wxWindowID id = SYMBOL_XMLELEMENTDLG_IDNAME, const wxString& caption = SYMBOL_XMLELEMENTDLG_TITLE, const wxPoint& pos = SYMBOL_XMLELEMENTDLG_POSITION, const wxSize& size = SYMBOL_XMLELEMENTDLG_SIZE, long style = SYMBOL_XMLELEMENTDLG_STYLE );
...
////@begin XMLElementDlg event handler declarations
    ...
    void OnCdXmlDatasourceSelected( wxCommandEvent& event );

    /// wxEVT_COMMAND_COMBOBOX_SELECTED event handler for CD_XML_SCHEMA
    void OnCdXmlSchemaSelected( wxCommandEvent& event );
    ...
    void OnCdXmlKeygenClick( wxCommandEvent& event );
...
////@begin XMLElementDlg member variables
    ...
    wxOwnerDrawnComboBox* mColumnname;
    wxStaticText* mAliasC;
    wxTextCtrl* mAlias;
    wxStaticText* mUtablenameC;
    wxOwnerDrawnComboBox* mUtablename;
    wxStaticText* mUcolumnnameC;
    wxOwnerDrawnComboBox* mUcolumnname;
    ...
    wxOwnerDrawnComboBox* mItablename;
    wxStaticText* mIcolumnnameC;
    wxOwnerDrawnComboBox* mIcolumnname;
...
////@end XMLElementDlg member variables
  ...
  dad_element_node * el;
 // key generation data:
  char id_column[ATTRNAMELEN+1];
  t_key_generator_type key_generator;
  wxString key_generator_expression;
};
